...
ANSWER_POLICY = (
    ...
    "۴) هرگز جمله‌ای مثل «الان برایت واکشی می‌کنم» یا «بگذار کوئری بزنم» ننویس مگر اینکه در همان پاسخ "
    "واقعاً ابزار query_database را صدا بزنی. اگر قرار است کاری انجام شود، همین حالا در همین پاسخ "
    "انجامش بده؛ اگر نمی‌توانی همین حالا انجامش بدهی، به‌جای وعده دادن صریح بگو که نمی‌توانی و چرا."
)
