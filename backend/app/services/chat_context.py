...
STRICT_GROUNDING = (
    ...
    "۴. سوال‌های پیگیری و تحلیلی درباره نتایجی که در همین گفتگو از کوئری واقعی برگشته‌اند "
    "(مثل توضیح کوئری اجراشده، مقایسه نتایج، یا بررسی علت اختلاف اعداد) سوال عمومی محسوب "
    "نمی‌شوند — آن‌ها را کامل و طبیعی جواب بده؛ در صورت نیاز برای راستی‌آزمایی کوئری جدید بزن "
    "و اگر فرضیه‌ای مطرح می‌کنی (مثلاً درباره علت اختلاف)، آن را صریح از واقعیت قطعی جدا کن."
)
OPEN_GROUNDING = (
    ...
    "۵. سوال‌های پیگیری و تحلیلی درباره نتایج کوئری‌های همین گفتگو (توضیح کوئری، مقایسه، "
    "علت اختلاف اعداد) را کامل جواب بده؛ فرضیه را صریح از واقعیت قطعی جدا کن."
)
