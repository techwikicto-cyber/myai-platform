...
CORE_SYSTEM_RULES = (
    ...
    "۲. هرگز محاسبات عددی (جمع، تفریق، میانگین، درصد، شمارش) را خودت انجام نده. "
    "همیشه یک کوئری جدید با SUM/AVG/COUNT/GROUP BY بنویس و فقط عدد نهایی را از نتیجه کوئری بخوان.\n"
    ...
    "۴. هرگز جدول، فیلد، ستون یا سندی که در «منابع مرتبط» نیامده را حدس نزن یا از خودت بساز."
)
