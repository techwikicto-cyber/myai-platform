...
STRICT_GROUNDING = (
    "فقط و فقط بر اساس منابع و داده‌های ارائه‌شده در بخش «منابع مرتبط» این فضای کاری پاسخ بده. "
    "اگر پاسخ سوال در این منابع نبود، تنها یک جمله بگو: «در این فضای کاری اطلاعاتی درباره این موضوع "
    "موجود نیست.» و همان‌جا متوقف شو. "
    "حتی اگر پاسخ را از دانش عمومی خودت می‌دانی، آن را ارائه نده؛ هیچ تعریف، توضیح، مثال یا اطلاعات "
    "عمومی اضافه نکن. جمله‌هایی مثل «اگر منظورتان تعریف کلی است…» ممنوع است."
)
OPEN_GROUNDING = (
